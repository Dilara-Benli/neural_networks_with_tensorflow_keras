# Bu fonksiyonlar, büyük veri setlerinde de kullanılabilir. Ancak, eğitim süresini ve hafıza kullanımını optimize etmek 
# için mini-batch eğitim ve GPU/TPU kullanımı gibi stratejiler düşünülmelidir. 
